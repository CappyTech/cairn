...
// Initial Cairn schema: users (+ public_key, last_seen), contacts,
// location_shares, pair_requests — with their privacy rules. Runs once on a
// fresh database. Generated from cairn-collections.json.
migrate((app) => {
  const toImport = [
    {
        "id":  "_pb_users_auth_",
    ...
    },
    {
        ...
        "updated":  "2026-09-13 16:15:38.395Z",
        "system":  false
    },
    {
        "id":  "pbc_3043038444",
...
;
  ...
  // down migration: leave collections in place
});
